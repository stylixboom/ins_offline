...
namespace ins_offline_AutoVersion{
	...
	//Date Version Types
	static const char ins_offline_DATE[] = "15";
	...
	static const long ins_offline_BUILD  = 135;
	static const long ins_offline_REVISION  = 468;
	
	//Miscellaneous Version Types
	static const long ins_offline_BUILDS_COUNT  = 130;
	#define ins_offline_RC_FILEVERSION 1,6,135,468
	#define ins_offline_RC_FILEVERSION_STRING "1, 6, 135, 468\0"
	static const char ins_offline_FULLVERSION_STRING [] = "1.6.135.468";
	
	//These values are to keep track of your versioning state, don't modify them.
	static const long ins_offline_BUILD_HISTORY  = 86;

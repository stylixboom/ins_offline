...
namespace ins_offline_AutoVersion{
	...
	static const long ins_offline_BUILD  = 66;
	static const long ins_offline_REVISION  = 103;
	
	//Miscellaneous Version Types
	static const long ins_offline_BUILDS_COUNT  = 28;
	#define ins_offline_RC_FILEVERSION 1,6,66,103
	#define ins_offline_RC_FILEVERSION_STRING "1, 6, 66, 103\0"
	static const char ins_offline_FULLVERSION_STRING [] = "1.6.66.103";
	
	//These values are to keep track of your versioning state, don't modify them.
	static const long ins_offline_BUILD_HISTORY  = 17;
